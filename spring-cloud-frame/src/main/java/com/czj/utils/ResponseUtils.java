...
import com.czj.framework.responses.FailedResponse;
...
//                response.writeValueAsJson(failedResponse);
//            }
//        }
//    }
//
...
//                failedResponseBuilder.errmsg(error.getDefaultMessage());
//            });
...
//            failedResponseBuilder.exception(builder.toString()).errmsg(ex.getMessage());
//            return failedResponseBuilder;
...
//                builder.append("校验不通过");
//                failedResponseBuilder.exception(builder.toString()).errmsg(constraintViolation.getMessage());
//            }
//            return failedResponseBuilder;
//        }
//
